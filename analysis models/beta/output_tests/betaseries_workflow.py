...
def combine_timeseries():
    ...
    roi_dir = glob.glob(os.path.join(
        "/projects/niblab/bids_projects/Experiments/Bevel/derivatives/betaseries/output/timeseries/by_roi/*.txt"))
...
def main():
    ...
    output_dir = "/projects/niblab/bids_projects/Experiments/Bevel/derivatives/betaseries/output/new_rois/niftis"
    # os.chdir(basepath)
