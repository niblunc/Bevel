...
for sub_dir in SUBJECTS:
    ...
    # Fill in Paths
    fmri_anat = os.path.join(fmriprep_dir, sub_id, "anat/%s_space-MNI152Lin_desc-preproc_T1w.nii.gz"%sub_id)
    print("ANAT PATH: ", fmri_anat)
    copy2(fmri_anat, anat_path)
    fmri_funcs = glob.glob(os.path.join(fmriprep_dir, sub_id, "func/*preproc_bold.nii.gz"))
    for func in fmri_funcs:
        print("FUNCS: ", func)
